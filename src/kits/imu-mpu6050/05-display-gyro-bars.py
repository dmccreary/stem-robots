...
# X, Y, Z angular velocity - grow left or right from a center line as you
# rotate/spin the sensor, and settle back near center when it's still.
I2C_SDA_PIN = 10
I2C_SCL_PIN = 11
I2C_BUS = 1
...
MAX_DPS = 250.0      # angular velocity at full bar deflection
...
def draw_bar(y, value):
    length = int((value / MAX_DPS) * BAR_HALF_WIDTH)
...
def draw_frame(gx, gy, gz):
    oled.fill(BLACK)
    for label, y, value in zip(LABELS, ROW_Y, (gx, gy, gz)):
