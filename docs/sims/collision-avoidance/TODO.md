...
- **Framework:** p5.js
- **Detected subjects:** Mathematics, Physics, Chemistry, Statistics, Engineering
- **Visualization types:** simulation, interactive-demo, network
- **Has main.html:** No
- **Has index.md:** Yes
