...
|---|---------|-------|--------|-------|
| 1 | Concepts | 240 | Required | Concepts from learning graph |
| 2 | Chapters | 13 | Required | Chapter directories with index.md |
| 3 | MicroSims | 26 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 0 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 12 / 13 | Recommended | Chapters with a quiz.md (120 questions total) |
| 6 | Chapter References | 0 / 13 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 266 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 89 | Recommended | Questions in faq.md |
| 9 | Words | 117,862 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 20 | 20 | H4 headers starting with '#### Diagram:' |
| Equations | 0 | 0 | LaTeX expressions (inline and display) |
| Total Words | 117,862 | 50,675 | Words in markdown files |
| Links | 512 | 114 | Hyperlinks in markdown format |
| Equivalent Pages | 489 | 220 | Estimated pages (250 words/page + visuals) |
